...
cluster = pca.transform(dat_x)
# pl.scatter(dat_y, cluster, s=1)
# pl.show()

# dat_x_cluster = pd.DataFrame(dat_x)
# dat_x_cluster['label'] = dat_y
# dat_x_cluster['cluster'] = cluster
# # ... -36 ... -15 ...
# dat_x_cluster[dat_x_cluster['cluster'] > -15].drop('cluster')
# reduced_data = cluster
...
# pl.scatter(X_plot, np.exp(log_dens), s=5)
# pl.show()

dat_x['cluster'] = cluster
