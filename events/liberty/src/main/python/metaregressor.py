...
def meta_fit(dat_x, dat_y, train_index, cv_index, lb_x, main_fold_id):
    ...
    train_x.tofile(dataloc + "fold_" + main_fold_id +"_train_x.dat")
    train_y.tofile(dataloc + "fold_" + main_fold_id +"_train_y.dat")
    cv_x.tofile(dataloc + "fold_" + main_fold_id +"_cv_x.dat")
    subm_x.tofile(dataloc + "fold_" + main_fold_id +"_subm_x.dat")
