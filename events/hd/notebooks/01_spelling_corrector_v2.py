...
df_train = pd.read_csv("~/data/kaggle/homedepot/train.csv", encoding="ISO-8859-1")
df_test = pd.read_csv("~/data/kaggle/homedepot/test.csv", encoding="ISO-8859-1")
...
def str_spel(s):
    ...
    if s in spell_check_dict :
        speel_check_search= spell_check_dict[s]
    else:
        speel_check_search= s
    return speel_check_search
...
df_train['search_term'] = df_train['search_term'].map(lambda x:str_spel(x))
df_test['search_term'] = df_test['search_term'].map(lambda x:str_spel(x))

df_train.to_csv('~/data/kaggle/homedepot/train_spel.csv',index=False)
df_test.to_csv('~/data/kaggle/homedepot/test_spel.csv',index=False)
